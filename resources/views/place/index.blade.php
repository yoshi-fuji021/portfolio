			...
			<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
				<div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
					...
					<div class="mt-5 px-4 py-5">
						...
						<a href="{{ route('place.create') }}" class="bg-orange-500 text-white font-bold px-4 py-2 rounded float-right mr-5">作成</a>
							...
							<tbody>
								@foreach($places as $place)
									<tr>
										...
										<td class="px-3 py-3 text-center border">
											<a href="{{ route('place.show', ['place' => $place->id])}}" class="bg-orange-500 text-white font-bold px-4 py-3 rounded">詳細</a>
										</td>
